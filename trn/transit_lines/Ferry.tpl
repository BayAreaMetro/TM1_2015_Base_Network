...
link nodes=14120,14600, time=13.0, dist=225, oneway=no, modes=100-109; Treasure Island - SF Ferry
link nodes=14503,14608, time=10, dist=180, oneway=no,modes=100-105; Tiburon - Sausalito
...
LINE NAME="100_ALAOAKFW", RUNTIME=40, ONEWAY=T, MODE=100, 
     OWNER="25", COLOR=1,  
     FREQ[1]=0,
     FREQ[2]=0,
     FREQ[3]=0,
...
LINE NAME="100_SSFALOAK", RUNTIME=35, ONEWAY=T, MODE=100, 
     OWNER="25", COLOR=1, 
     FREQ[1]=0,
     FREQ[2]=0,
     FREQ[3]=0,
...
LINE NAME="100_ALOAKSSF", RUNTIME=35, ONEWAY=T, MODE=100, 
     OWNER="25", COLOR=1, 
     FREQ[1]=0,
     FREQ[2]=80,
     FREQ[3]=0,
...
LINE NAME="100_SSFFB", RUNTIME=30, ONEWAY=T, MODE=100, 
     OWNER="25", COLOR=1, 
     FREQ[1]=0,
     FREQ[2]=240,
     FREQ[3]=0,
 ...
 LINE NAME="100_FBSSF", RUNTIME=30, ONEWAY=T, MODE=100, 
      OWNER="25", COLOR=1, 
      FREQ[1]=0,
      FREQ[2]=0,
      FREQ[3]=0,
