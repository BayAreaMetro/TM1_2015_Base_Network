...
LINE NAME="104_FWFBVALMI", RUNTIME=70, ONEWAY=T, MODE=104, OWNER="24",
     COLOR=1,  
     FREQ[1]=0,
     FREQ[2]=0,
     FREQ[3]=0,
...
LINE NAME="104_MIVALFWFB", RUNTIME=70, ONEWAY=T, MODE=104, OWNER="24",
     COLOR=1,  
     FREQ[1]=0,
     FREQ[2]=0,
     FREQ[3]=300,
     FREQ[4]=240,
     FREQ[5]=0,
     N=14613, 14606, -14607, -14500, 14601, -14602, 14600     
