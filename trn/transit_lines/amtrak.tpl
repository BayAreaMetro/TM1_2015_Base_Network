...
;
LINK NODES= 14641,14642, TIME =6.0, DIST=290, ONEWAY=YES, MODES=131-132 ; San Jose - Santa Clara
LINK NODES= 14642,14643, TIME =7.0, DIST=380, ONEWAY=YES, MODES=131-132 ; Santa Clara - Great America
LINK NODES= 14642,14641, TIME =17.0, DIST=290, ONEWAY=YES, MODES=131-132 ; Santa Clara - San Jose
...
LINK NODES= 14644,14646, TIME =15.0, DIST=910, ONEWAY=NO, MODES=131-132 ; Fremont - Hayward
LINK NODES= 14646,14647, TIME =10.0, DIST=810, ONEWAY=NO, MODES=131-132 ; Hayward - Coliseum
LINK NODES= 14647,14648, TIME =8.0, DIST=510, ONEWAY=NO, MODES=131-132 ; Coliseum - Jack London Square
LINK NODES= 14648,14649, TIME =9.0, DIST=320, ONEWAY=NO, MODES=131-132 ; Jack London Square - Emeryville
...
LINE NAME="131_CAP1NB", LONGNAME=AMTRAK_Capitol_SanJose_to_Fairfield_Vacaville, ONEWAY=T, MODE=131, OWNER="6", COLOR=10,
     ...
     FREQ[4]=80,
     FREQ[5]=480,
     N=14641, 14642, 14643, 14644, 14646, 14647, 14648, 14649, 14650, 14651, 14654, 14655
...
LINE NAME="131_CAP1SB", LONGNAME=AMTRAK_Capitol_Fairfield_Vacaville_to_SanJose, ONEWAY=T, MODE=131, OWNER="6", COLOR=10,
     ...
     FREQ[4]=80,
     FREQ[5]=480,
     N=14655, 14654, 14651, 14650, 14649, 14648, 14647, 14646, 14644, 14643, 14642, 14641
